...
public class ManagerForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 0, 140, 130));

        jLabel6.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(255, 255, 255));
        jLabel6.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel6.setText("USER");
        jPanel2.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 130, 140, 30));
        ...
        Add.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 140, 50));
        ...
        Edit.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 140, 50));

        jPanel2.add(Edit, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 220, 140, 50));

        jPanel4.setBackground(new java.awt.Color(51, 255, 0));

        print.setBackground(new java.awt.Color(0, 255, 0));
        print.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        print.setForeground(new java.awt.Color(255, 255, 255));
        print.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ICONS/icons8-edit-property-30.png"))); // NOI18N
        print.setText("   PRINT");
        ...
        jPanel2.add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 280, 140, 50));

        jPanel1.add(jPanel2);
        jPanel2.setBounds(0, 0, 160, 510);
        ...
        if(rowIndex < 0){
            ...
            try{
                ...
                if(rs.next()){
                 ...
                 af.acctype.setSelectedItem(""+rs.getString("user_account"));
                 af.stats.setSelectedItem(""+rs.getString("user_status"));
                 af.image.setIcon(af.ResizeImage(rs.getString("user_image"),null, af.image));
                 af.oldpath = rs.getString("user_image");
                 af.path = rs.getString("user_image");
                 af.destination = rs.getString("user_image");
                 af.add.setEnabled(false);
                 af.update.setEnabled(true);
                 af.setVisible(true);
                 ...
                 if(rs.getString("user_image").isEmpty()){
                     ...
                     af.remove.setEnabled(false);
                      ...
                      af.select.setEnabled(false);
                     af.remove.setEnabled(true);
                 }
                 this.dispose();
            }
            }catch(SQLException ex){
        ...
        if(rowIndex < 0){
            ...
            try{
                ...
                if(rs.next()){
                 ...
                 up.uid.setText(""+rs.getString("user_id"));
                 up.fn.setText(""+rs.getString("user_firstname"));
                 up.ln.setText(""+rs.getString("user_lastname"));
                 up.email.setText(""+rs.getString("user_email"));
                 up.un.setText(""+rs.getString("username")); 
                 up.at.setText(""+rs.getString("user_account"));
                 up.st.setText(""+rs.getString("user_status"));
                 
                 up.image.setIcon(up.ResizeImage(rs.getString("user_image"),null,up.image));
                 up.setVisible(true);
                 this.dispose();
            }
            }catch(SQLException ex){
